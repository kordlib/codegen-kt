...
public inline fun <reified R, reified R_> LambdaTypeName(parameters: List<ParameterSpec> = emptyList(), contextReceivers: List<TypeName> = emptyList()): LambdaTypeName = LambdaTypeName(typeNameOf<R>(), parameters, typeNameOf<R_>(), contextReceivers)
