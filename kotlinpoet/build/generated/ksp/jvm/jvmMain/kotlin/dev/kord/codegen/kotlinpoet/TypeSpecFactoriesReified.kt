...
public inline fun <reified C> TypeSpec.Companion.expectClass(block: TypeSpecBuilderScope = {}): TypeSpec {
  contract { callsInPlace(block, EXACTLY_ONCE) }
  return expectClass(C::class.asClassName(), block)
}

public inline fun <reified C> TypeSpec.Companion.`object`(block: TypeSpecBuilderScope = {}): TypeSpec {
  contract { callsInPlace(block, EXACTLY_ONCE) }
  return `object`(C::class.asClassName(), block)
}

public inline fun <reified C> TypeSpec.Companion.`interface`(block: TypeSpecBuilderScope = {}): TypeSpec {
  contract { callsInPlace(block, EXACTLY_ONCE) }
  return `interface`(C::class.asClassName(), block)
}

public inline fun <reified C> TypeSpec.Companion.funInterface(block: TypeSpecBuilderScope = {}): TypeSpec {
  contract { callsInPlace(block, EXACTLY_ONCE) }
...
public inline fun <reified C> TypeSpec.Companion.`annotation`(block: TypeSpecBuilderScope = {}): TypeSpec {
  contract { callsInPlace(block, EXACTLY_ONCE) }
